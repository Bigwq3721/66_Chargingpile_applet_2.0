...
function populateParameters(result) {
  ...
  var parameters = {
    ...
    appName: "66_Chargingpile_applet",
    appVersion: "1.0.0",
    appVersionCode: "100",
...
function initData(vueOptions, context) {
  ...
  if (typeof data === 'function') {
    try {
      ...
      if (Object({"NODE_ENV":"development","VUE_APP_DARK_MODE":"false","VUE_APP_NAME":"66_Chargingpile_applet","VUE_APP_PLATFORM":"mp-weixin","BASE_URL":"/"}).VUE_APP_DEBUG) {
...
/***/ 26:
/*!********************************************************************************!*\
  !*** C:/Users/44553/Desktop/微信图片视频/备份代码/66_Chargingpile_applet_2.0/pages.json ***!
  \********************************************************************************/
/*! no static exports found */
/***/ (function(module, exports) {
...
/***/ 30:
/*!**************************************************************************************!*\
  !*** C:/Users/44553/Desktop/微信图片视频/备份代码/66_Chargingpile_applet_2.0/common/Config.js ***!
  \**************************************************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {
...
(0, _defineProperty2.default)(Config, "baseUrl", "https://test.yueguisuchong.com");
(0, _defineProperty2.default)(Config, "api", "https://test.yueguisuchong.com/quickuser50/");
(0, _defineProperty2.default)(Config, "api1", "https://test.yueguisuchong.com/quick_manager50/");
(0, _defineProperty2.default)(Config, "wx", "wss://test.yueguisuchong.com/quickuser50/device/ws/");
(0, _defineProperty2.default)(Config, "imgapi", "https://test.yueguisuchong.com/quickuser50");
(0, _defineProperty2.default)(Config, "imgUrl", "https://test.yueguisuchong.com/tabBarimg/");
...
/***/ 34:
/*!************************************************************************************!*\
  !*** C:/Users/44553/Desktop/微信图片视频/备份代码/66_Chargingpile_applet_2.0/common/Base.js ***!
  \************************************************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {
...
var _classCallCheck2 = _interopRequireDefault(__webpack_require__(/*! @babel/runtime/helpers/classCallCheck */ 23));
var _createClass2 = _interopRequireDefault(__webpack_require__(/*! @babel/runtime/helpers/createClass */ 24));
var _Config = __webpack_require__(/*! ./Config.js */ 30);
var _dialog = _interopRequireDefault(__webpack_require__(/*! wxcomponents/vant/dialog/dialog */ 35));
var Base = /*#__PURE__*/function () {
  function Base() {
    (0, _classCallCheck2.default)(this, Base);
    this.url = _Config.Config.api;
    this.url1 = _Config.Config.api1;
    this.imgurl = _Config.Config.imgapi;
  ...
  (0, _createClass2.default)(Base, [{
    ...
    key: "showLoginPromptWithMessage",
    value: function showLoginPromptWithMessage(message) {
      var _this = this;
      // 防止重复显示弹窗
      ...
      return new Promise(function (resolve, reject) {
        uni.showModal({
          ...
          success: function success(res) {
            _this.isShowingLoginPrompt = false; // 重置标志
            if (res.confirm) {
              resolve(true); // 用户选择登录
            } else {
    ...
    key: "isLoginRequiredFeature",
    value: function isLoginRequiredFeature(featureName) {
      // 定义需要强制登录的功能列表
      var loginRequiredFeatures = ['charge',
      // 充电功能
      'recharge',
      // 充值功能
      'account',
    ...
    key: "handleLoginRequired",
    value: function handleLoginRequired() {
      var featureName = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : 'default';
      // 获取当前页面路径和参数
      var pages = getCurrentPages();
      var currentPage = pages[pages.length - 1];
      var fullPath = currentPage.$page.fullPath;
      ...
      if (fullPath.indexOf('device=') > -1 && fullPath.indexOf('port=') > -1) {
        // 从URL中提取设备ID和端口号
        var deviceMatch = fullPath.match(/device=([^&]+)/);
        var portMatch = fullPath.match(/port=([^&]+)/);
        if (deviceMatch && portMatch) {
          var device = deviceMatch[1];
      ...
      // 根据功能类型显示不同的提示信息
      var promptMessage = '您需要登录后才能继续使用该功能，是否立即登录？';
      ...
      // 显示登录提示弹窗
      this.showLoginPromptWithMessage(promptMessage).then(function (shouldLogin) {
        if (shouldLogin) {
          // 用户选择登录，清除存储并跳转到登录页面
          ...
          if (scanParams) {
            // 如果有扫码参数，直接传递给登录页面
            uni.navigateTo({
              url: "/pages/login/login?device=".concat(scanParams.device, "&port=").concat(scanParams.port)
            });
          } else {
            // 否则正常跳转
            uni.navigateTo({
    ...
    key: "request",
    value: function request(url, method, data, header) {
      var _this2 = this;
      return new Promise(function (resolve, reject) {
        if (!header) {
          header = {
        ...
        uni.request({
          ...
          timeout: 15000,
          success: function success(res) {
            if (Number(res.data.code) == '70004' || (res.data.msg + '').indexOf("请先登录") >= 0 || (res.data.msg + '').indexOf("无效token") >= 0) {
              // 检查当前页面是否允许游客浏览
              var pages = getCurrentPages();
              var currentPage = pages[pages.length - 1];
              ...
              // 允许游客浏览的页面列表
              var guestAllowedPages = ['pages/index/index', 'pages/smcharging/smcharging', 'pageone/nearby_charging/nearby_charging', 'pageone/trouble_shooting/trouble_shooting'];
    ...
    key: "request1",
    value: function request1(url, method, data, header) {
      var _this3 = this;
      return new Promise(function (resolve, reject) {
        if (!header) {
          header = {
    ...
    value: function fetchData() {
      return new Promise(function (resolve, reject) {
        var cacheExpireTime = uni.getStorageSync('cacheExpireTime'); // 缓存过期时间戳
        var cachedData = uni.getStorageSync('cachedData'); // 缓存的数据
        // 检查缓存是否过期
    ...
    key: "checkLoginWithPrompt",
    value: function checkLoginWithPrompt() {
      var userToken = uni.getStorageSync('userToken');
      if (!userToken) {
        this.handleLoginRequired();
        return false;
    ...
    value: function loginPage() {
      this.showLoginPrompt().then(function (shouldLogin) {
        if (shouldLogin) {
          uni.navigateTo({
            url: "/pages/login/login"
          });
    ...
    key: "directLoginPage",
    value: function directLoginPage() {
      uni.navigateTo({
        url: "/pages/login/login"
      });
    }
    ...
    key: "prompt",
    value: function prompt(arg1, arg2, cb1, cb2) {
      uni.showModal({
        title: arg1,
        content: arg2,
        success: function success(res) {
    ...
    key: "agreement",
    value: function agreement(data) {
      var _this4 = this;
      return new Promise(function (resolve, reject) {
        _this4.request('wxlogin/agreement', 'GET', data).then(function (res) {
          resolve(res);
        }).catch(function (err) {
          reject(err);
        });
...
/***/ 35:
/*!********************************************************************************************************!*\
  !*** C:/Users/44553/Desktop/微信图片视频/备份代码/66_Chargingpile_applet_2.0/wxcomponents/vant/dialog/dialog.js ***!
  \********************************************************************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {
...
/***/ 36:
/*!*************************************************************************************!*\
  !*** C:/Users/44553/Desktop/微信图片视频/备份代码/66_Chargingpile_applet_2.0/common/share.js ***!
  \*************************************************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {
...
/***/ 483:
/*!************************************************************************************************************!*\
  !*** C:/Users/44553/Desktop/微信图片视频/备份代码/66_Chargingpile_applet_2.0/components/uni-load-more/i18n/index.js ***!
  \************************************************************************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {
...
/***/ 484:
/*!***********************************************************************************************************!*\
  !*** C:/Users/44553/Desktop/微信图片视频/备份代码/66_Chargingpile_applet_2.0/components/uni-load-more/i18n/en.json ***!
  \***********************************************************************************************************/
...
/***/ 485:
/*!****************************************************************************************************************!*\
  !*** C:/Users/44553/Desktop/微信图片视频/备份代码/66_Chargingpile_applet_2.0/components/uni-load-more/i18n/zh-Hans.json ***!
  \****************************************************************************************************************/
/*! exports provided: uni-load-more.contentdown, uni-load-more.contentrefresh, uni-load-more.contentnomore, default */
/***/ (function(module) {
...
/***/ 486:
/*!****************************************************************************************************************!*\
  !*** C:/Users/44553/Desktop/微信图片视频/备份代码/66_Chargingpile_applet_2.0/components/uni-load-more/i18n/zh-Hant.json ***!
  \****************************************************************************************************************/
/*! exports provided: uni-load-more.contentdown, uni-load-more.contentrefresh, uni-load-more.contentnomore, default */
/***/ (function(module) {
...
/***/ 501:
/*!******************************************************************************************************************!*\
  !*** C:/Users/44553/Desktop/微信图片视频/备份代码/66_Chargingpile_applet_2.0/components/uni-datetime-picker/i18n/index.js ***!
  \******************************************************************************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {
...
exports.default = void 0;
var _en = _interopRequireDefault(__webpack_require__(/*! ./en.json */ 502));
var _zhHans = _interopRequireDefault(__webpack_require__(/*! ./zh-Hans.json */ 503));
var _zhHant = _interopRequireDefault(__webpack_require__(/*! ./zh-Hant.json */ 504));
var _default = {
  en: _en.default,
  'zh-Hans': _zhHans.default,
  'zh-Hant': _zhHant.default
...
/***/ 502:
/*!*****************************************************************************************************************!*\
  !*** C:/Users/44553/Desktop/微信图片视频/备份代码/66_Chargingpile_applet_2.0/components/uni-datetime-picker/i18n/en.json ***!
  \*****************************************************************************************************************/
...
/***/ 503:
/*!**********************************************************************************************************************!*\
  !*** C:/Users/44553/Desktop/微信图片视频/备份代码/66_Chargingpile_applet_2.0/components/uni-datetime-picker/i18n/zh-Hans.json ***!
  \**********************************************************************************************************************/
...
/***/ 504:
/*!**********************************************************************************************************************!*\
  !*** C:/Users/44553/Desktop/微信图片视频/备份代码/66_Chargingpile_applet_2.0/components/uni-datetime-picker/i18n/zh-Hant.json ***!
  \**********************************************************************************************************************/
/*! exports provided: uni-datetime-picker.selectDate, uni-datetime-picker.selectTime, uni-datetime-picker.selectDateTime, uni-datetime-picker.startDate, uni-datetime-picker.endDate, uni-datetime-picker.startTime, uni-datetime-picker.endTime, uni-datetime-picker.ok, uni-datetime-picker.clear, uni-datetime-picker.cancel, uni-calender.SUN, uni-calender.MON, uni-calender.TUE, uni-calender.WED, uni-calender.THU, uni-calender.FRI, uni-calender.SAT, default */
/***/ (function(module) {
...
/***/ 519:
/*!************************************************************************************************************!*\
  !*** C:/Users/44553/Desktop/微信图片视频/备份代码/66_Chargingpile_applet_2.0/components/uni-datetime-picker/util.js ***!
  \************************************************************************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {
...
/***/ 53:
/*!******************************************************************************************************!*\
  !*** C:/Users/44553/Desktop/微信图片视频/备份代码/66_Chargingpile_applet_2.0/wxcomponents/vant/toast/toast.js ***!
  \******************************************************************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {
...
exports.default = void 0;
var _validator = __webpack_require__(/*! ../common/validator */ 54);
var defaultOptions = {
  type: 'text',
  mask: false,
  message: '',
...
/***/ 54:
/*!***********************************************************************************************************!*\
  !*** C:/Users/44553/Desktop/微信图片视频/备份代码/66_Chargingpile_applet_2.0/wxcomponents/vant/common/validator.js ***!
  \***********************************************************************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {
